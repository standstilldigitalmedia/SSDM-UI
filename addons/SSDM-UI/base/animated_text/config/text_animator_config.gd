## Configuration resource for SSDMTextAnimator.[br]
...
## Can be used independently of SSDM-UI panels for dialogue systems, RPG text, etc.
class_name SSDMTextAnimatorConfig
extends Resource
...
@export var animate_scale: bool = false  ## Enable scale animation (grow/shrink effect).
@export var scale_from: Vector2 = Vector2(0.1, 0.1)  ## Starting scale (1.0 = normal size).
@export var scale_to: Vector2 = Vector2.ONE  ## Ending scale (1.0 = normal size).
...
@export var animate_rotation: bool = false  ## Enable rotation animation (spin effect).
@export var rotation_from_degrees: float = 0.0  ## Starting rotation angle in degrees.
@export var rotation_to_degrees: float = 360.0  ## Ending rotation angle in degrees.
...
@export var animate_position: bool = false  ## Enable position animation (move/slide effect).
...
@export var animate_fade: bool = false  ## Enable fade animation (transparency effect).
...
@export var animation_speed: float = 1.0  ## Duration of transform animations in seconds.
@export var transition_type: Tween.TransitionType = Tween.TRANS_CUBIC  ## Math curve for tween animations.
@export var ease_type: Tween.EaseType = Tween.EASE_OUT  ## Easing for tween animations.
