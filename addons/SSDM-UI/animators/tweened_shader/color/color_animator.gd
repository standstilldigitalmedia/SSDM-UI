...
func _init(
		...
		tween_animator = SSDMUITransformAnimatorBase.new(shader_material, animation_parent, SSDMUIGlobal.SHADER_PARAMETER + SSDMUIGlobal.BACKGROUND_COLOR, speed, background_color, to_color, transition_type, ease_type_play, ease_type_reverse, set_parallel, main_tween)
