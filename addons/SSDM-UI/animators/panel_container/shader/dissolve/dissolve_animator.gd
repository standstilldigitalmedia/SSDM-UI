...
func tween_forward() -> void:
	main_tween.tween_property(shader_material, SSDMCanvasShaderGlobal.SHADER_PARAMETER + SSDMCanvasShaderGlobal.DISSOLVE_PROGRESS, 1.0, animation_speed)
...
func tween_reverse() -> void:
	...
	main_tween.tween_property(shader_material, SSDMCanvasShaderGlobal.SHADER_PARAMETER + SSDMCanvasShaderGlobal.DISSOLVE_PROGRESS, 0.0, animation_speed * float(current_progress))	
