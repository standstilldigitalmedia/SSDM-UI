...
func _tween_forward() -> void:
	...
	_main_tween.tween_property(shader_material, SSDMUISingleControlShaderAnimatorBase.SHADER_PARAMETER + SSDMUISingleControlShaderAnimatorBase.PROGRESS, 0.0, speed * float(1.0))	
	
	
func _tween_reverse() -> void:
	shader_material.set_shader_parameter(SSDMUISingleControlShaderAnimatorBase.PROGRESS, 0.0)
	_main_tween.tween_property(shader_material, SSDMUISingleControlShaderAnimatorBase.SHADER_PARAMETER + SSDMUISingleControlShaderAnimatorBase.PROGRESS, 1.0, speed)
