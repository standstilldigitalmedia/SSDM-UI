...
func set_speed(new_speed: float) -> void:
	set_shader_parameter(_speed_parameter_name, new_speed)


func set_background_color(new_background_color: Color) -> void:
	set_shader_parameter(SSDMUIGlobal.BACKGROUND_COLOR, new_background_color)
...
func _enable_shader() -> void:
	set_shader_parameter(_enable_parameter_name, 1.0)
	
	
func _disable_shader() -> void:
	set_shader_parameter(_enable_parameter_name, 0.0)
