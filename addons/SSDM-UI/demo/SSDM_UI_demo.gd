## Demo script for SSDM-UI addon.[br]
...
## res://addons/SSDM-UI/demo/SSDM_UI_demo.tscn
extends Control
...
@export var buttered_sausage_display: SSDMToastDisplay
...
func _on_demo_scenarios_pressed() -> void:
	...
	parent_result.with_info("Batch operation completed successfully. It is a good thing this is done now. I'd hate for this to wait until Monday because the boss can be a real SSDMManager.")
